...
class Exchange(models.Model):
    ...
    from_card = models.ForeignKey(Currency, on_delete=models.SET_NULL, null=True, related_name='from_card_name')
    to_card = models.ForeignKey(Currency, on_delete=models.SET_NULL, null=True, related_name='to_card_name')
    from_number = models.CharField(max_length=50, null=True)
    to_number = models.CharField(max_length=50, null=True)
